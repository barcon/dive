...
def CreateCavity(x, y, z, nx, ny, nz, quadratic):
    ...
    gmsh.model.geo.addPoint(0.0,   y, 0.0, 0, 4)
    gmsh.model.geo.addPoint(0.0, 0.0,   z, 0, 5)
    gmsh.model.geo.addPoint(  x, 0.0,   z, 0, 6)
    gmsh.model.geo.addPoint(  x,   y,   z, 0, 7)
    gmsh.model.geo.addPoint(0.0,   y,   z, 0, 8)
    ...
    gmsh.model.mesh.setTransfiniteCurve( 3, nx, "Bump", 0.05)
    gmsh.model.mesh.setTransfiniteCurve( 5, nx, "Bump", 0.05)
    gmsh.model.mesh.setTransfiniteCurve( 7, nx, "Bump", 0.05)

    gmsh.model.mesh.setTransfiniteCurve( 2, ny, "Bump", 0.05)
    ...
    gmsh.model.addPhysicalGroup(2, [3, 5, 6], name="wallViscous")
