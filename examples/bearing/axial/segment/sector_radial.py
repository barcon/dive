...
class SectorRadial:
    ...
    def GetPoints(self):
        ...
        alpha2 = math.pi * self.angle / (180.0 * 2.0)

        x2 = radiusInner * math.cos(alpha1)
        y2 = radiusInner * math.sin(alpha1)

        x3 = radiusInner * math.cos(alpha2)
        y3 = radiusInner * math.sin(alpha2)
        ...
        x8 = radiusOuter * math.cos(alpha2)
        y8 = radiusOuter * math.sin(alpha2)
        ...
        if self.chamfer == "none":
            ...
            aux =  radiusInner * radiusInner - self.chamferLength * self.chamferLength
            if (aux >= 0):
                xt = math.sqrt(aux)
                yt = -self.chamferLength

                x12 = xt * math.cos(alpha2) - yt * math.sin(alpha2)
                y12 = xt * math.sin(alpha2) + yt * math.cos(alpha2)

            aux = radiusOuter * radiusOuter - self.chamferLength * self.chamferLength
            if (aux >= 0):
                xt = math.sqrt(aux)
                yt = -self.chamferLength

                x13 = xt * math.cos(alpha2) - yt * math.sin(alpha2)
                y13 = yt * math.sin(alpha2) + yt * math.cos(alpha2)
