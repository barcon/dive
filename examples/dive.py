...
quadrature_four = cvar.quadrature_four
quadrature_undefined = cvar.quadrature_undefined
...
integral_one = cvar.integral_one
integral_two = cvar.integral_two
integral_three = cvar.integral_three
integral_undefined = cvar.integral_undefined
element_mass = cvar.element_mass
element_combined = cvar.element_combined
element_hexa81 = cvar.element_hexa81
element_hexa82 = cvar.element_hexa82
element_hexa83 = cvar.element_hexa83
element_hexa201 = cvar.element_hexa201
element_hexa202 = cvar.element_hexa202
element_hexa203 = cvar.element_hexa203
...
class IElementMapped(IElement):
    ...
    def NN(self, *args):
        return _dive.IElementMapped_NN(self, *args)
...
class CacheCommon(object):
    ...
    NN = property(_dive.CacheCommon_NN_get, _dive.CacheCommon_NN_set)
...
def CreateElementHexa81(elementTag):
    return _dive.CreateElementHexa81(elementTag)

def CreateElementHexa82(elementTag):
    return _dive.CreateElementHexa82(elementTag)

def CreateElementHexa83(elementTag):
    return _dive.CreateElementHexa83(elementTag)

def CreateElementHexa201(elementTag):
    return _dive.CreateElementHexa201(elementTag)

def CreateElementHexa202(elementTag):
    return _dive.CreateElementHexa202(elementTag)

def CreateElementHexa203(elementTag):
    return _dive.CreateElementHexa203(elementTag)
...
class ElementHexa(IElementSolid):
    ...
    def NN(self, *args):
        return _dive.ElementHexa_NN(self, *args)
...
def ApplyMaterial(mesh, material):
    return _dive.ApplyMaterial(mesh, material)

def DeformByInterpolation(mesh, interpolation):
    return _dive.DeformByInterpolation(mesh, interpolation)

def GmshInitialize():
    return _dive.GmshInitialize()

def GmshFinalize():
    return _dive.GmshFinalize()

def GmshOpenFile(fileName):
    return _dive.GmshOpenFile(fileName)

def GmshGetNodesForPhysicalGroup(mesh, groupName):
    return _dive.GmshGetNodesForPhysicalGroup(mesh, groupName)
...
def FilterEdgeByNodes(element, input):
    return _dive.FilterEdgeByNodes(element, input)
