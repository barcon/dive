...
namespace dive
{
    namespace weakforms
    {
		...
		class StiffnessStructural : public WeakFormElement, virtual public std::enable_shared_from_this<StiffnessStructural>
		{
		public:
		...
		protected:
			...
			Matrix FormMatrix_D(IElementPtr element, const Vector& local) const;
