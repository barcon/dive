#ifndef DIVE_WEAKFORMS_PRESSURE_CROSSED_UDP_HPP_
#define DIVE_WEAKFORMS_PRESSURE_CROSSED_UDP_HPP_
...
namespace dive
{
    namespace weakforms
    {
		...
		public:
			...
			static CrossedPressure_Udp_Ptr Create();
			CrossedPressure_Udp_Ptr GetPtr();
			ConstCrossedPressure_Udp_Ptr GetPtr() const;
...
#endif /* DIVE_WEAKFORMS_PRESSURE_CROSSED_Udp_HPP_ */