#include "dive_weakforms_pressure_crossed1.hpp"

namespace dive {
	namespace weakforms {
		CrossedPressure_UdpPtr CreateWeakFormCrossedPressure_Udp()
		{
			auto res = CrossedPressure_Udp::Create();

			return res;
		}
		CrossedPressure_UdpPtr CrossedPressure_Udp::Create()
		{
		...
		CrossedPressure_UdpPtr CrossedPressure_Udp::GetPtr()
		{
			return std::dynamic_pointer_cast<CrossedPressure_Udp>(shared_from_this());
		}
		ConstCrossedPressure_UdpPtr CrossedPressure_Udp::GetPtr() const
		{
