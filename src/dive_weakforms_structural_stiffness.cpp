...
namespace dive {
	namespace weakforms {
		...
		void StiffnessStructural::WeakFormulation(IElementMappedPtr element, const Vector& local, Matrix& output) const
		{		
		...
		Matrix StiffnessStructural::FormMatrix_B(IElementMappedPtr element, const Vector& local) const
		{
