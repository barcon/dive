...
class VectorCL(object):
    ...
    def Convert(self):
        return _dive.VectorCL_Convert(self)
...
class EllpackCL(object):
    ...
    def Convert(self):
        return _dive.EllpackCL_Convert(self)
...
def IterativeCGCL(A, x, b, callbackIterative):
    return _dive.IterativeCGCL(A, x, b, callbackIterative)

def IterativeBiCGStabCL(A, x, b, callbackIterative):
    return _dive.IterativeBiCGStabCL(A, x, b, callbackIterative)
...
def CreateGaussHexa(value):
    return _dive.CreateGaussHexa(value)
...
def CreateGaussRect(value):
    return _dive.CreateGaussRect(value)
...
def CreateGaussLine(value):
    return _dive.CreateGaussLine(value)
...
class vecFacePairs(object):
    ...
    def iterator(self):
        return _dive.vecFacePairs_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _dive.vecFacePairs___nonzero__(self)

    def __bool__(self):
        return _dive.vecFacePairs___bool__(self)

    def __len__(self):
        return _dive.vecFacePairs___len__(self)

    def __getslice__(self, i, j):
        return _dive.vecFacePairs___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _dive.vecFacePairs___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _dive.vecFacePairs___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _dive.vecFacePairs___delitem__(self, *args)

    def __getitem__(self, *args):
        return _dive.vecFacePairs___getitem__(self, *args)

    def __setitem__(self, *args):
        return _dive.vecFacePairs___setitem__(self, *args)

    def pop(self):
        return _dive.vecFacePairs_pop(self)

    def append(self, x):
        return _dive.vecFacePairs_append(self, x)

    def empty(self):
        return _dive.vecFacePairs_empty(self)

    def size(self):
        return _dive.vecFacePairs_size(self)

    def swap(self, v):
        return _dive.vecFacePairs_swap(self, v)

    def begin(self):
        return _dive.vecFacePairs_begin(self)

    def end(self):
        return _dive.vecFacePairs_end(self)

    def rbegin(self):
        return _dive.vecFacePairs_rbegin(self)

    def rend(self):
        return _dive.vecFacePairs_rend(self)

    def clear(self):
        return _dive.vecFacePairs_clear(self)

    def get_allocator(self):
        return _dive.vecFacePairs_get_allocator(self)

    def pop_back(self):
        return _dive.vecFacePairs_pop_back(self)

    def erase(self, *args):
        return _dive.vecFacePairs_erase(self, *args)

    def __init__(self, *args):
        _dive.vecFacePairs_swiginit(self, _dive.new_vecFacePairs(*args))

    def push_back(self, x):
        return _dive.vecFacePairs_push_back(self, x)

    def front(self):
        return _dive.vecFacePairs_front(self)

    def back(self):
        return _dive.vecFacePairs_back(self)

    def assign(self, n, x):
        return _dive.vecFacePairs_assign(self, n, x)

    def resize(self, *args):
        return _dive.vecFacePairs_resize(self, *args)

    def insert(self, *args):
        return _dive.vecFacePairs_insert(self, *args)

    def reserve(self, n):
        return _dive.vecFacePairs_reserve(self, n)

    def capacity(self):
        return _dive.vecFacePairs_capacity(self)
    __swig_destroy__ = _dive.delete_vecFacePairs

# Register vecFacePairs in _dive:
_dive.vecFacePairs_swigregister(vecFacePairs)
class vecEdgePairs(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _dive.vecEdgePairs_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _dive.vecEdgePairs___nonzero__(self)

    def __bool__(self):
        return _dive.vecEdgePairs___bool__(self)

    def __len__(self):
        return _dive.vecEdgePairs___len__(self)

    def __getslice__(self, i, j):
        return _dive.vecEdgePairs___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _dive.vecEdgePairs___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _dive.vecEdgePairs___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _dive.vecEdgePairs___delitem__(self, *args)

    def __getitem__(self, *args):
        return _dive.vecEdgePairs___getitem__(self, *args)

    def __setitem__(self, *args):
        return _dive.vecEdgePairs___setitem__(self, *args)

    def pop(self):
        return _dive.vecEdgePairs_pop(self)

    def append(self, x):
        return _dive.vecEdgePairs_append(self, x)

    def empty(self):
        return _dive.vecEdgePairs_empty(self)

    def size(self):
        return _dive.vecEdgePairs_size(self)

    def swap(self, v):
        return _dive.vecEdgePairs_swap(self, v)

    def begin(self):
        return _dive.vecEdgePairs_begin(self)

    def end(self):
        return _dive.vecEdgePairs_end(self)

    def rbegin(self):
        return _dive.vecEdgePairs_rbegin(self)

    def rend(self):
        return _dive.vecEdgePairs_rend(self)

    def clear(self):
        return _dive.vecEdgePairs_clear(self)

    def get_allocator(self):
        return _dive.vecEdgePairs_get_allocator(self)

    def pop_back(self):
        return _dive.vecEdgePairs_pop_back(self)

    def erase(self, *args):
        return _dive.vecEdgePairs_erase(self, *args)

    def __init__(self, *args):
        _dive.vecEdgePairs_swiginit(self, _dive.new_vecEdgePairs(*args))

    def push_back(self, x):
        return _dive.vecEdgePairs_push_back(self, x)

    def front(self):
        return _dive.vecEdgePairs_front(self)

    def back(self):
        return _dive.vecEdgePairs_back(self)

    def assign(self, n, x):
        return _dive.vecEdgePairs_assign(self, n, x)

    def resize(self, *args):
        return _dive.vecEdgePairs_resize(self, *args)

    def insert(self, *args):
        return _dive.vecEdgePairs_insert(self, *args)

    def reserve(self, n):
        return _dive.vecEdgePairs_reserve(self, n)

    def capacity(self):
        return _dive.vecEdgePairs_capacity(self)
    __swig_destroy__ = _dive.delete_vecEdgePairs

# Register vecEdgePairs in _dive:
_dive.vecEdgePairs_swigregister(vecEdgePairs)
...
class FacePair(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    element = property(_dive.FacePair_element_get, _dive.FacePair_element_set)
    faceIndex = property(_dive.FacePair_faceIndex_get, _dive.FacePair_faceIndex_set)

    def __init__(self):
        _dive.FacePair_swiginit(self, _dive.new_FacePair())
    __swig_destroy__ = _dive.delete_FacePair

# Register FacePair in _dive:
_dive.FacePair_swigregister(FacePair)
class EdgePair(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    element = property(_dive.EdgePair_element_get, _dive.EdgePair_element_set)
    edgeIndex = property(_dive.EdgePair_edgeIndex_get, _dive.EdgePair_edgeIndex_set)

    def __init__(self):
        _dive.EdgePair_swiginit(self, _dive.new_EdgePair())
    __swig_destroy__ = _dive.delete_EdgePair

# Register EdgePair in _dive:
_dive.EdgePair_swigregister(EdgePair)
...
class IElementMapped(IElement):
    ...
    def SetParametric(self, parametric):
        return _dive.IElementMapped_SetParametric(self, parametric)

    def SetIntegral(self, integral):
        return _dive.IElementMapped_SetIntegral(self, integral)
...
class ElementHexa(IElementSolid):
    ...
    def SetParametric(self, parametric):
        return _dive.ElementHexa_SetParametric(self, parametric)

    def SetIntegral(self, integral):
        return _dive.ElementHexa_SetIntegral(self, integral)
...
def CreateElementCombined(*args):
    return _dive.CreateElementCombined(*args)

def CastToElementCombined(element):
    return _dive.CastToElementCombined(element)
class ElementCombined(IElement):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _dive.delete_ElementCombined

    @staticmethod
    def Create():
        return _dive.ElementCombined_Create()

    def GetPtr(self, *args):
        return _dive.ElementCombined_GetPtr(self, *args)

    def GetTag(self):
        return _dive.ElementCombined_GetTag(self)

    def GetType(self):
        return _dive.ElementCombined_GetType(self)

    def GetCenter(self):
        return _dive.ElementCombined_GetCenter(self)

    def GetMaterial(self):
        return _dive.ElementCombined_GetMaterial(self)

    def GetNodeIndex(self, node):
        return _dive.ElementCombined_GetNodeIndex(self, node)

    def GetElementIndex(self):
        return _dive.ElementCombined_GetElementIndex(self)

    def GetNumberDof(self):
        return _dive.ElementCombined_GetNumberDof(self)

    def GetNumberNodes(self):
        return _dive.ElementCombined_GetNumberNodes(self)

    def GetNumberFaces(self):
        return _dive.ElementCombined_GetNumberFaces(self)

    def GetNumberEdges(self):
        return _dive.ElementCombined_GetNumberEdges(self)

    def GetNumberNodesFace(self, faceNumber):
        return _dive.ElementCombined_GetNumberNodesFace(self, faceNumber)

    def GetNumberNodesEdge(self, edgeNode):
        return _dive.ElementCombined_GetNumberNodesEdge(self, edgeNode)

    def GetNumberDimensions(self):
        return _dive.ElementCombined_GetNumberDimensions(self)

    def GetNumberCoordinates(self):
        return _dive.ElementCombined_GetNumberCoordinates(self)

    def GetNode(self, nodeNumber):
        return _dive.ElementCombined_GetNode(self, nodeNumber)

    def GetNodeFace(self, faceNumber, nodeNumber):
        return _dive.ElementCombined_GetNodeFace(self, faceNumber, nodeNumber)

    def GetNodeEdge(self, edgeNumber, nodeNumber):
        return _dive.ElementCombined_GetNodeEdge(self, edgeNumber, nodeNumber)

    def GetNodes(self):
        return _dive.ElementCombined_GetNodes(self)

    def GetProperty(self, key):
        return _dive.ElementCombined_GetProperty(self, key)

    def SetTag(self, elementTag):
        return _dive.ElementCombined_SetTag(self, elementTag)

    def SetNumberDof(self, numberDof):
        return _dive.ElementCombined_SetNumberDof(self, numberDof)

    def SetNode(self, nodeNumber, node):
        return _dive.ElementCombined_SetNode(self, nodeNumber, node)

    def SetElementIndex(self, index):
        return _dive.ElementCombined_SetElementIndex(self, index)

    def SetMaterial(self, material):
        return _dive.ElementCombined_SetMaterial(self, material)

    def SetProperty(self, value):
        return _dive.ElementCombined_SetProperty(self, value)

    def LocalCoordinates(self, *args):
        return _dive.ElementCombined_LocalCoordinates(self, *args)

    def GlobalCoordinates(self, *args):
        return _dive.ElementCombined_GlobalCoordinates(self, *args)

    def SizeMinimum(self):
        return _dive.ElementCombined_SizeMinimum(self)

    def SizeMaximum(self):
        return _dive.ElementCombined_SizeMaximum(self)

    def IsUsed(self, node):
        return _dive.ElementCombined_IsUsed(self, node)

    def IsMapped(self):
        return _dive.ElementCombined_IsMapped(self)

    def IsCacheable(self):
        return _dive.ElementCombined_IsCacheable(self)

    def InitializeCache(self):
        return _dive.ElementCombined_InitializeCache(self)

    def GetStiffness(self):
        return _dive.ElementCombined_GetStiffness(self)
    ...
    def SetDamping(self, damping):
        return _dive.ElementCombined_SetDamping(self, damping)

    def Stiffness(self, output):
        return _dive.ElementCombined_Stiffness(self, output)

    def Damping(self, output):
        return _dive.ElementCombined_Damping(self, output)

# Register ElementCombined in _dive:
_dive.ElementCombined_swigregister(ElementCombined)
...
class IFluid(IProblem):
    ...
    def Mass(self, *args):
        return _dive.IFluid_Mass(self, *args)

    def Stiffness(self, *args):
        return _dive.IFluid_Stiffness(self, *args)

    def Convection(self, *args):
        return _dive.IFluid_Convection(self, *args)

    def ConvectionSymmetric(self, *args):
        return _dive.IFluid_ConvectionSymmetric(self, *args)

    def ConvectionAsymmetric(self, *args):
        return _dive.IFluid_ConvectionAsymmetric(self, *args)

    def Stabilization(self, *args):
        return _dive.IFluid_Stabilization(self, *args)

    def LoadDistributedVolume(self, *args):
        return _dive.IFluid_LoadDistributedVolume(self, *args)

    def LoadDistributedVolumeStabilization(self, *args):
        return _dive.IFluid_LoadDistributedVolumeStabilization(self, *args)

    def Momentum(self, *args):
        return _dive.IFluid_Momentum(self, *args)

    def Velocity(self, *args):
        return _dive.IFluid_Velocity(self, *args)
...
class IPressure(IProblem):
    ...
    def Mass(self, *args):
        return _dive.IPressure_Mass(self, *args)

    def Stiffness(self, *args):
        return _dive.IPressure_Stiffness(self, *args)

    def Crossed(self, *args):
        return _dive.IPressure_Crossed(self, *args)

    def Stabilization(self, *args):
        return _dive.IPressure_Stabilization(self, *args)

    def DistributedVolumeDivergence(self, *args):
        return _dive.IPressure_DistributedVolumeDivergence(self, *args)

    def Pressure(self, *args):
        return _dive.IPressure_Pressure(self, *args)
...
class IThermal(IProblem):
    ...
    def Mass(self, *args):
        return _dive.IThermal_Mass(self, *args)

    def Stiffness(self, *args):
        return _dive.IThermal_Stiffness(self, *args)

    def Convection(self, *args):
        return _dive.IThermal_Convection(self, *args)

    def Stabilization(self, *args):
        return _dive.IThermal_Stabilization(self, *args)

    def Energy(self, *args):
        return _dive.IThermal_Energy(self, *args)
...
class IStructural(IProblem):
    ...
    def Damping(self):
        return _dive.IStructural_Damping(self)
...
class ProblemThermal(IThermal):
    ...
    def Mass(self, *args):
        return _dive.ProblemThermal_Mass(self, *args)

    def Stiffness(self, *args):
        return _dive.ProblemThermal_Stiffness(self, *args)

    def Convection(self, *args):
        return _dive.ProblemThermal_Convection(self, *args)

    def Stabilization(self, *args):
        return _dive.ProblemThermal_Stabilization(self, *args)

    def Energy(self, *args):
        return _dive.ProblemThermal_Energy(self, *args)
...
class ProblemFluid(IFluid):
    ...
    def Mass(self, *args):
        return _dive.ProblemFluid_Mass(self, *args)

    def Stiffness(self, *args):
        return _dive.ProblemFluid_Stiffness(self, *args)

    def Convection(self, *args):
        return _dive.ProblemFluid_Convection(self, *args)

    def ConvectionSymmetric(self, *args):
        return _dive.ProblemFluid_ConvectionSymmetric(self, *args)

    def ConvectionAsymmetric(self, *args):
        return _dive.ProblemFluid_ConvectionAsymmetric(self, *args)

    def Stabilization(self, *args):
        return _dive.ProblemFluid_Stabilization(self, *args)

    def LoadDistributedVolume(self, *args):
        return _dive.ProblemFluid_LoadDistributedVolume(self, *args)

    def LoadDistributedVolumeStabilization(self, *args):
        return _dive.ProblemFluid_LoadDistributedVolumeStabilization(self, *args)

    def Momentum(self, *args):
        return _dive.ProblemFluid_Momentum(self, *args)

    def Velocity(self, *args):
        return _dive.ProblemFluid_Velocity(self, *args)
...
class ProblemPressure(IPressure):
    ...
    def Mass(self, *args):
        return _dive.ProblemPressure_Mass(self, *args)

    def Stiffness(self, *args):
        return _dive.ProblemPressure_Stiffness(self, *args)

    def Crossed(self, *args):
        return _dive.ProblemPressure_Crossed(self, *args)

    def Stabilization(self, *args):
        return _dive.ProblemPressure_Stabilization(self, *args)

    def DistributedVolumeDivergence(self, *args):
        return _dive.ProblemPressure_DistributedVolumeDivergence(self, *args)

    def Pressure(self, *args):
        return _dive.ProblemPressure_Pressure(self, *args)
...
class ProblemStructural(IStructural):
    ...
    def Damping(self):
        return _dive.ProblemStructural_Damping(self)
...
def FilterElementsByNodesIntersection(input):
    return _dive.FilterElementsByNodesIntersection(input)
...
def FilterFaceByNodes(element, input):
    return _dive.FilterFaceByNodes(element, input)
class SpecSortNodesByTag(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _dive.SpecSortNodesByTag_swiginit(self, _dive.new_SpecSortNodesByTag())

    def IsSatisfied(self, item1, item2):
        return _dive.SpecSortNodesByTag_IsSatisfied(self, item1, item2)
    __swig_destroy__ = _dive.delete_SpecSortNodesByTag

# Register SpecSortNodesByTag in _dive:
_dive.SpecSortNodesByTag_swigregister(SpecSortNodesByTag)
...
def SortNodesByTag(input):
    return _dive.SortNodesByTag(input)
...
class SpecSortElementsByTag(object):
    ...
    def __init__(self):
        _dive.SpecSortElementsByTag_swiginit(self, _dive.new_SpecSortElementsByTag())

    def IsSatisfied(self, item1, item2):
        return _dive.SpecSortElementsByTag_IsSatisfied(self, item1, item2)
    __swig_destroy__ = _dive.delete_SpecSortElementsByTag

# Register SpecSortElementsByTag in _dive:
_dive.SpecSortElementsByTag_swigregister(SpecSortElementsByTag)

def SortElements(spec, input):
    return _dive.SortElements(spec, input)

def SortElementsByTag(input):
    return _dive.SortElementsByTag(input)
