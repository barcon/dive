...
namespace dive
{
	namespace problems
	{
		...
		public:
			...
			Sparse Crossed(IProblemPtr problemVelocity) const override;
			Sparse Stabilization(IProblemPtr problemVelocity) const override;
			Vector LoadDistributedFaceFlux(IProblemPtr problemVelocity, const Vector& momentum) const override;
