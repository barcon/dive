#ifndef DIVE_WEAKFORM_STRUCTURAL_LOAD_DISTRIBUTED_EDGE_HPP_
#define DIVE_WEAKFORM_STRUCTURAL_LOAD_DISTRIBUTED_EDGE_HPP_
...
#endif /* DIVE_WEAKFORM_STRUCTURAL_LOAD_DISTRIBUTED_EDGE_HPP_ */