...
class IPressure(IProblem):
    ...
    def LoadDistributedVolumeDivergence(self, problemMomentum):
        return _diveCL.IPressure_LoadDistributedVolumeDivergence(self, problemMomentum)
...
class ProblemPressure(IPressure):
    ...
    def LoadDistributedVolumeDivergence(self, problemMomentum):
        return _diveCL.ProblemPressure_LoadDistributedVolumeDivergence(self, problemMomentum)
