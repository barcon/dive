...
def CreateValueMatrix1D(*args):
    return _diveCL.CreateValueMatrix1D(*args)
...
def CreateValueMatrix2D(*args):
    return _diveCL.CreateValueMatrix2D(*args)
...
class vecFacePairs(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _diveCL.vecFacePairs_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _diveCL.vecFacePairs___nonzero__(self)

    def __bool__(self):
        return _diveCL.vecFacePairs___bool__(self)

    def __len__(self):
        return _diveCL.vecFacePairs___len__(self)

    def __getslice__(self, i, j):
        return _diveCL.vecFacePairs___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _diveCL.vecFacePairs___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _diveCL.vecFacePairs___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _diveCL.vecFacePairs___delitem__(self, *args)

    def __getitem__(self, *args):
        return _diveCL.vecFacePairs___getitem__(self, *args)

    def __setitem__(self, *args):
        return _diveCL.vecFacePairs___setitem__(self, *args)

    def pop(self):
        return _diveCL.vecFacePairs_pop(self)

    def append(self, x):
        return _diveCL.vecFacePairs_append(self, x)

    def empty(self):
        return _diveCL.vecFacePairs_empty(self)

    def size(self):
        return _diveCL.vecFacePairs_size(self)

    def swap(self, v):
        return _diveCL.vecFacePairs_swap(self, v)

    def begin(self):
        return _diveCL.vecFacePairs_begin(self)

    def end(self):
        return _diveCL.vecFacePairs_end(self)

    def rbegin(self):
        return _diveCL.vecFacePairs_rbegin(self)

    def rend(self):
        return _diveCL.vecFacePairs_rend(self)

    def clear(self):
        return _diveCL.vecFacePairs_clear(self)

    def get_allocator(self):
        return _diveCL.vecFacePairs_get_allocator(self)

    def pop_back(self):
        return _diveCL.vecFacePairs_pop_back(self)

    def erase(self, *args):
        return _diveCL.vecFacePairs_erase(self, *args)

    def __init__(self, *args):
        _diveCL.vecFacePairs_swiginit(self, _diveCL.new_vecFacePairs(*args))

    def push_back(self, x):
        return _diveCL.vecFacePairs_push_back(self, x)

    def front(self):
        return _diveCL.vecFacePairs_front(self)

    def back(self):
        return _diveCL.vecFacePairs_back(self)

    def assign(self, n, x):
        return _diveCL.vecFacePairs_assign(self, n, x)

    def resize(self, *args):
        return _diveCL.vecFacePairs_resize(self, *args)

    def insert(self, *args):
        return _diveCL.vecFacePairs_insert(self, *args)

    def reserve(self, n):
        return _diveCL.vecFacePairs_reserve(self, n)

    def capacity(self):
        return _diveCL.vecFacePairs_capacity(self)
    __swig_destroy__ = _diveCL.delete_vecFacePairs

# Register vecFacePairs in _diveCL:
_diveCL.vecFacePairs_swigregister(vecFacePairs)
class vecEdgePairs(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _diveCL.vecEdgePairs_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _diveCL.vecEdgePairs___nonzero__(self)

    def __bool__(self):
        return _diveCL.vecEdgePairs___bool__(self)

    def __len__(self):
        return _diveCL.vecEdgePairs___len__(self)

    def __getslice__(self, i, j):
        return _diveCL.vecEdgePairs___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _diveCL.vecEdgePairs___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _diveCL.vecEdgePairs___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _diveCL.vecEdgePairs___delitem__(self, *args)

    def __getitem__(self, *args):
        return _diveCL.vecEdgePairs___getitem__(self, *args)

    def __setitem__(self, *args):
        return _diveCL.vecEdgePairs___setitem__(self, *args)

    def pop(self):
        return _diveCL.vecEdgePairs_pop(self)

    def append(self, x):
        return _diveCL.vecEdgePairs_append(self, x)

    def empty(self):
        return _diveCL.vecEdgePairs_empty(self)

    def size(self):
        return _diveCL.vecEdgePairs_size(self)

    def swap(self, v):
        return _diveCL.vecEdgePairs_swap(self, v)

    def begin(self):
        return _diveCL.vecEdgePairs_begin(self)

    def end(self):
        return _diveCL.vecEdgePairs_end(self)

    def rbegin(self):
        return _diveCL.vecEdgePairs_rbegin(self)

    def rend(self):
        return _diveCL.vecEdgePairs_rend(self)

    def clear(self):
        return _diveCL.vecEdgePairs_clear(self)

    def get_allocator(self):
        return _diveCL.vecEdgePairs_get_allocator(self)

    def pop_back(self):
        return _diveCL.vecEdgePairs_pop_back(self)

    def erase(self, *args):
        return _diveCL.vecEdgePairs_erase(self, *args)

    def __init__(self, *args):
        _diveCL.vecEdgePairs_swiginit(self, _diveCL.new_vecEdgePairs(*args))

    def push_back(self, x):
        return _diveCL.vecEdgePairs_push_back(self, x)

    def front(self):
        return _diveCL.vecEdgePairs_front(self)

    def back(self):
        return _diveCL.vecEdgePairs_back(self)

    def assign(self, n, x):
        return _diveCL.vecEdgePairs_assign(self, n, x)

    def resize(self, *args):
        return _diveCL.vecEdgePairs_resize(self, *args)

    def insert(self, *args):
        return _diveCL.vecEdgePairs_insert(self, *args)

    def reserve(self, n):
        return _diveCL.vecEdgePairs_reserve(self, n)

    def capacity(self):
        return _diveCL.vecEdgePairs_capacity(self)
    __swig_destroy__ = _diveCL.delete_vecEdgePairs

# Register vecEdgePairs in _diveCL:
_diveCL.vecEdgePairs_swigregister(vecEdgePairs)
...
class FacePair(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    element = property(_diveCL.FacePair_element_get, _diveCL.FacePair_element_set)
    faceIndex = property(_diveCL.FacePair_faceIndex_get, _diveCL.FacePair_faceIndex_set)

    def __init__(self):
        _diveCL.FacePair_swiginit(self, _diveCL.new_FacePair())
    __swig_destroy__ = _diveCL.delete_FacePair

# Register FacePair in _diveCL:
_diveCL.FacePair_swigregister(FacePair)
class EdgePair(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    element = property(_diveCL.EdgePair_element_get, _diveCL.EdgePair_element_set)
    edgeIndex = property(_diveCL.EdgePair_edgeIndex_get, _diveCL.EdgePair_edgeIndex_set)

    def __init__(self):
        _diveCL.EdgePair_swiginit(self, _diveCL.new_EdgePair())
    __swig_destroy__ = _diveCL.delete_EdgePair

# Register EdgePair in _diveCL:
_diveCL.EdgePair_swigregister(EdgePair)
...
class ElementCombined(IElement):
    ...
    def SetCanonical(self, canonical):
        return _diveCL.ElementCombined_SetCanonical(self, canonical)
...
class IMesh(object):
    ...
    def SortNodesByTag(self):
        return _diveCL.IMesh_SortNodesByTag(self)

    def SortElementsByTag(self):
        return _diveCL.IMesh_SortElementsByTag(self)
...
class Mesh(IMesh):
    ...
    def SortNodesByTag(self):
        return _diveCL.Mesh_SortNodesByTag(self)

    def SortElementsByTag(self):
        return _diveCL.Mesh_SortElementsByTag(self)
...
class IWeakFormElement(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _diveCL.delete_IWeakFormElement

    def WeakFormulation(self, element, cacheIndex, local, output):
        return _diveCL.IWeakFormElement_WeakFormulation(self, element, cacheIndex, local, output)

# Register IWeakFormElement in _diveCL:
_diveCL.IWeakFormElement_swigregister(IWeakFormElement)
class IWeakFormLoad(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _diveCL.delete_IWeakFormLoad

    def WeakFormulation(self, load, local, output):
        return _diveCL.IWeakFormLoad_WeakFormulation(self, load, local, output)

# Register IWeakFormLoad in _diveCL:
_diveCL.IWeakFormLoad_swigregister(IWeakFormLoad)
...
def FilterElementsByNodesIntersection(input):
    return _diveCL.FilterElementsByNodesIntersection(input)

def FilterElementsRemoveDuplicates(input):
    return _diveCL.FilterElementsRemoveDuplicates(input)

def FilterFaceByNodes(element, input):
    return _diveCL.FilterFaceByNodes(element, input)
class SpecSortNodesByTag(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _diveCL.SpecSortNodesByTag_swiginit(self, _diveCL.new_SpecSortNodesByTag())

    def IsSatisfied(self, item1, item2):
        return _diveCL.SpecSortNodesByTag_IsSatisfied(self, item1, item2)
    __swig_destroy__ = _diveCL.delete_SpecSortNodesByTag

# Register SpecSortNodesByTag in _diveCL:
_diveCL.SpecSortNodesByTag_swigregister(SpecSortNodesByTag)
...
def SortNodesByTag(input):
    return _diveCL.SortNodesByTag(input)

def SortNodesByCoordinate(input, basis, axis):
    return _diveCL.SortNodesByCoordinate(input, basis, axis)
class SpecSortElementsByTag(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _diveCL.SpecSortElementsByTag_swiginit(self, _diveCL.new_SpecSortElementsByTag())

    def IsSatisfied(self, item1, item2):
        return _diveCL.SpecSortElementsByTag_IsSatisfied(self, item1, item2)
    __swig_destroy__ = _diveCL.delete_SpecSortElementsByTag

# Register SpecSortElementsByTag in _diveCL:
_diveCL.SpecSortElementsByTag_swigregister(SpecSortElementsByTag)

def SortElements(spec, input):
    return _diveCL.SortElements(spec, input)

def SortElementsByTag(input):
    return _diveCL.SortElementsByTag(input)
