...
def __add__(*args):
    return _diveCL.__add__(*args)

def __sub__(*args):
    return _diveCL.__sub__(*args)

def __mul__(*args):
    return _diveCL.__mul__(*args)

def Add(*args):
    return _diveCL.Add(*args)

def Sub(*args):
    return _diveCL.Sub(*args)

def Mul(*args):
    return _diveCL.Mul(*args)
...
def __lshift__(stream, vector):
    return _diveCL.__lshift__(stream, vector)
