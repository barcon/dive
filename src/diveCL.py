...
load_distributed_volume_transient = cvar.load_distributed_volume_transient
load_distributed_face = cvar.load_distributed_face
load_distributed_face_transient = cvar.load_distributed_face_transient
load_distributed_edge = cvar.load_distributed_edge
load_distributed_edge_transient = cvar.load_distributed_edge_transient
load_node = cvar.load_node
load_node_transient = cvar.load_node_transient
load_initial_strain = cvar.load_initial_strain
load_temperature_strain = cvar.load_temperature_strain
load_heat_source_volume = cvar.load_heat_source_volume
load_heat_conduction_face = cvar.load_heat_conduction_face
load_coupling_equation = cvar.load_coupling_equation
