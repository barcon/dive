#ifndef DIVE_ELEMENT_HEXA_HPP_
#define DIVE_ELEMENT_HEXA_HPP_
...
namespace dive
{
	namespace element
	{
		...
		public:
			...
			Matrix Nt(const Vector& local) const override;
			...
			const Matrix& Nt(const CacheIndex& cacheIndex) const override;
